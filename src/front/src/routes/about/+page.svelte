...
<div class="about-container">
    ...
    <section class="project-details">
        ...
        <ul>
            <li><strong>Description:</strong> Our information sources focus on analyzing the evolution of aid for dependent individuals in Spain, examining key aspects such as social and economic support systems.</li>
            <li><strong>Repository:</strong> <a href="https://github.com/gti-sos/SOS2425-11" target="_blank" rel="noopener noreferrer"><i class="fab fa-github"></i> gti-sos/SOS2425-11</a></li>
            <li><strong>Live URL:</strong> <a href="https://sos2425-11.onrender.com/" target="_blank" rel="noopener noreferrer"><i class="fas fa-globe"></i> sos2425-11.onrender.com</a></li>
        </ul>
    </section>
