<script>
    ...
    */
    ...
    function handleSearch() {
        ...
        if (searchFilters.ageOver)
            params.set('ageOver', searchFilters.ageOver);
        if (searchFilters.ageUnder)
            params.set('ageUnder', searchFilters.ageUnder);
    ...
    <div class="container mx-auto max-w-7xl">
        ...
        >
            ...
            <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                ...
                <fieldset class="rounded-md border border-gray-300 p-3">
                    <legend class="px-1 text-sm font-medium text-gray-600">Incompatibilidad de Subvenciones</legend>
                    <div class="flex gap-2">
                        <input
                            type="number"
